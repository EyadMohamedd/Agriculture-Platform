...
namespace AgriculturalMonitorSystem.Src.Shared.Middleware;
...
public class FarmOwnershipMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        if (ownershipAttr != null)
        {
            ...
            // Admins see everything — bypass ownership check
            ...
            // Resolve per-request (scoped) — middleware is instantiated once from root provider
